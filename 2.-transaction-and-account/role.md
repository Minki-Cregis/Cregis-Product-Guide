...
<mark style="color:green;">**Please note that Wallet-specific permissions are managed separately, please refer to**</mark> [<mark style="color:blue;">**wallet member management**</mark>](wallet/wallet-member-management.md)<mark style="color:green;">**.**</mark>
...
Please note that editing permissions for applications within the Application Marketplace needs to be done separately on the[ <mark style="color:green;">**Application Management**</mark> ](../5.-marketplace/manage-applications.md)page.
