...
Once the setup is complete, proceed with identity verification. After authentication is complete, you will see a "Speeding Up" tag.&#x20;
...
After completing the setup, proceed with identity verification. After successful cancellation, the user interface will show two transaction records. The one with an amount of 0 is the record for the cancellation transaction, while the previous record will have a "Cancelled" tag.
