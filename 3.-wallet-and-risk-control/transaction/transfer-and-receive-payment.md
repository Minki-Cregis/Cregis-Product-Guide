...
7. After submitting the transaction request, please go to the [team activity page](../../2.-transaction-and-account/tasks/signing.md) to check the processing status. For detailed procedures, please refer to the relevant guide.
