...
Click on the dropdown menu in the default BTC address format row to select the BTC address format. For more information on the differences between formats, you can refer [here](../../6.-resources-documentation-and-terms/faq/wallet-management/why-does-btc-have-different-address-formats.md).
