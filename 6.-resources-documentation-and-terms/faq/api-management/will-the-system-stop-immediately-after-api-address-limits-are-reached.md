...
1.  **Upgrade Address Count**
    ...
    Go to the **Team Account** page to upgrade the address count. For detailed steps, refer to [here](../../../2.-transaction-and-account/images-and-media/paid-feature-activation.md#id-3.-increase-api-addresses).
