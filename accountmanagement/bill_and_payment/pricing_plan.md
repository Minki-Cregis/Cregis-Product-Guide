...
| **钱包地址**             | 99条       | 99条     | 99条      |
| **Tron能量代付折扣（普通交易）** | 9折        | 8.5折    | 7折       |
| **Tron能量代付折扣（归集）**   | 不适用       | 9折      | 7.5折     |
| **上币次数**             | 不适用       | 2次      | 5次       |
...
窗口会弹出显示Cregis提供的方案，确定方案后，您可以点击该方案中的「升级」按钮。
...
点击“立即支付”完成订单。请确保您的账户余额充足，您可以参考“[充值团队账户](recharge_your_account.md)”获取充值指南。
