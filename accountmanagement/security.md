...
如果您想获取用于Google身份验证器的密钥，您可以点击Google 2FA下的“编辑”。请注意您需要验证之前的Google身份验证器才可以进行下一步。
...
您可以在下方编辑您的邮箱。点击“编辑”，然后您需要进行Google身份验证器验证。
...
验证码将发送至您的新邮箱，您需要在Cregis中输入该验证码进行验证，验证后便可成功完成更改。
