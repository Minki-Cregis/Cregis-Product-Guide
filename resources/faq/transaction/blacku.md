...
4. 于地址点击"更多"，然后设为默认的收款及付款地址。

<figure><img src="../../../.gitbook/assets/image (1188).png" alt=""><figcaption></figcaption></figure>

除了以上步骤外，我们亦建议你使用 [<mark style="color:green;">**AML 工具**</mark>](../../../transaction-riskcontrol/aml_query.md)检查交易来源地址是否被列入高风险地址，同时请通知您的法务或合规团队，评估法律风险并处理资金。
