...
团队成员可使用的功能由其分配的角色决定。Cregis支持创建、编辑和删除角色，允许精确管理每个成员在团队中的权限。每个角色的权限范围可以根据具体需求进行细致调整。包含所有权限的超级管理员角色无法编辑或删除。
...
<mark style="color:green;">**请注意钱包有独立的权限设置，详情可参考**</mark>[<mark style="color:blue;">**钱包成员管理**</mark>](../wallet_and_transaction/wallet/members.md)<mark style="color:green;">**。**</mark>
...
<table><thead><tr><th width="239.03125">权限</th><th>定义</th></tr></thead><tbody><tr><td>查看</td><td>允许查看AML查询页面。</td></tr><tr><td>手动查询</td><td>允许进行手动AML查询。</td></tr><tr><td>创建规则</td><td>允许创建自动查询AML的规则</td></tr><tr><td>编辑规则</td><td>允许编辑自动查询AML的规则</td></tr><tr><td>删除规则</td><td>允许删除自动查询AML的规则</td></tr><tr><td>禁用／启用规则</td><td>允许禁用或启用自动查询AML的规则</td></tr></tbody></table>
