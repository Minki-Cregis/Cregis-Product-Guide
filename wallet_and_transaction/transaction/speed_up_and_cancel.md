...
设置完成后，点击确认并进行身份认证。认证完成后可见到加速中的标签![](<../../.gitbook/assets/image (958).png>)
...
设置完成后进行身份验证。成功取消后用户界面上会看到两条交易记录，金额为 0 的那条是取消交易的记录，而前一条记录则会有「已取消」的标签。![](<../../.gitbook/assets/image (963).png>)
